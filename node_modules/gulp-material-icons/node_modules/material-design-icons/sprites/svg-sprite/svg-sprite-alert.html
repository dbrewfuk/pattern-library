...
<style type="text/css">
.svg-ic_add_alert_24px {
	background: url(svg-sprite-alert.svg) 0 0 no-repeat;
	width: 24px;
	height: 24px;
}
.svg-ic_error_24px {
	background: url(svg-sprite-alert.svg) 100% 0 no-repeat;
	width: 24px;
	height: 24px;
}
.svg-ic_error_outline_24px {
	background: url(svg-sprite-alert.svg) 0 100% no-repeat;
	width: 24px;
	height: 24px;
}
.svg-ic_warning_24px {
	background: url(svg-sprite-alert.svg) 100% 100% no-repeat;
	width: 24px;
	height: 24px;
}
</style>
			...
			<ul>
				...
				<li title="ic_add_alert_24px">
					<div class="icon-box">
						...
						<!-- ic_add_alert_24px -->
						<i class="svg-ic_add_alert_24px">ic_add_alert_24px</i>
				...
				<li title="ic_error_24px">
					<div class="icon-box">
						...
						<!-- ic_error_24px -->
						<i class="svg-ic_error_24px">ic_error_24px</i>
				...
				<li title="ic_error_outline_24px">
					<div class="icon-box">
						...
						<i class="svg-ic_error_outline_24px">ic_error_outline_24px</i>
				...
				<li title="ic_warning_24px">
					<div class="icon-box">
						...
						<!-- ic_warning_24px -->
						<i class="svg-ic_warning_24px">ic_warning_24px</i>
