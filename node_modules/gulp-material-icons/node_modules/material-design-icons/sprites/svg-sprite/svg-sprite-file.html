			...
			<ul>
				...
				<li title="ic_attachment_24px">
					<div class="icon-box">
						...
						<!-- ic_attachment_24px -->
						<i class="svg-ic_attachment_24px">ic_attachment_24px</i>
				...
				<li title="ic_cloud_24px">
					<div class="icon-box">
						...
						<!-- ic_cloud_24px -->
						<i class="svg-ic_cloud_24px">ic_cloud_24px</i>
				...
				<li title="ic_cloud_circle_24px">
					<div class="icon-box">
						...
						<i class="svg-ic_cloud_circle_24px">ic_cloud_circle_24px</i>
				...
				<li title="ic_cloud_done_24px">
					<div class="icon-box">
						...
						<!-- ic_cloud_done_24px -->
						<i class="svg-ic_cloud_done_24px">ic_cloud_done_24px</i>
				...
				<li title="ic_cloud_download_24px">
					<div class="icon-box">
						...
						<i class="svg-ic_cloud_download_24px">ic_cloud_download_24px</i>
				...
				<li title="ic_cloud_off_24px">
					<div class="icon-box">
						...
						<!-- ic_cloud_off_24px -->
						<i class="svg-ic_cloud_off_24px">ic_cloud_off_24px</i>
				...
				<li title="ic_cloud_queue_24px">
					<div class="icon-box">
						...
						<!-- ic_cloud_queue_24px -->
						<i class="svg-ic_cloud_queue_24px">ic_cloud_queue_24px</i>
				...
				<li title="ic_cloud_upload_24px">
					<div class="icon-box">
						...
						<i class="svg-ic_cloud_upload_24px">ic_cloud_upload_24px</i>
				...
				<li title="ic_create_new_folder_24px">
					<div class="icon-box">
						...
						<i class="svg-ic_create_new_folder_24px">ic_create_new_folder_24px</i>
				...
				<li title="ic_file_download_24px">
					<div class="icon-box">
						...
						<i class="svg-ic_file_download_24px">ic_file_download_24px</i>
				...
				<li title="ic_file_upload_24px">
					<div class="icon-box">
						...
						<!-- ic_file_upload_24px -->
						<i class="svg-ic_file_upload_24px">ic_file_upload_24px</i>
				...
				<li title="ic_folder_24px">
					<div class="icon-box">
						...
						<!-- ic_folder_24px -->
						<i class="svg-ic_folder_24px">ic_folder_24px</i>
				...
				<li title="ic_folder_open_24px">
					<div class="icon-box">
						...
						<!-- ic_folder_open_24px -->
						<i class="svg-ic_folder_open_24px">ic_folder_open_24px</i>
				...
				<li title="ic_folder_shared_24px">
					<div class="icon-box">
						...
						<i class="svg-ic_folder_shared_24px">ic_folder_shared_24px</i>
